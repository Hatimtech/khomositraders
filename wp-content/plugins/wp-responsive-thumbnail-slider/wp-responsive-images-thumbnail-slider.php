...
function rts_responsive_thumbnail_slider_remove_access_capabilities(){
    ...
    function responsive_thumbnail_slider_load_styles_and_js(){
         ...
         if (!is_admin()) {                                                       
            ...
            wp_register_style( 'images-responsive-thumbnail-slider-style', plugins_url('/css/images-responsive-thumbnail-slider-style.css', __FILE__) );
            wp_register_script('images-responsive-thumbnail-slider-jc',plugins_url('/js/images-responsive-thumbnail-slider-jc.js', __FILE__),array(),'1.1.3');
